...
import io.whz.synapse.element.VerticalGap;
import io.whz.synapse.neural.MNISTUtil;
import io.whz.synapse.pojo.constant.PreferenceCons;
...
import io.whz.synapse.pojo.multiple.binder.PlayViewBinder;
import io.whz.synapse.pojo.multiple.binder.TrainedModelViewBinder;
import io.whz.synapse.pojo.multiple.binder.TrainingModelViewBinder;
import io.whz.synapse.pojo.multiple.binder.WelcomeViewBinder;
import io.whz.synapse.pojo.multiple.item.PlayItem;
import io.whz.synapse.pojo.multiple.item.TrainedModelItem;
...
import io.whz.synapse.transition.FabTransform;
import io.whz.synapse.util.DbHelper;
import io.whz.synapse.util.Precondition;
import me.drakeet.multitype.MultiTypeAdapter;

import static android.support.v4.content.PermissionChecker.PERMISSION_GRANTED;
import static io.whz.synapse.R.id.fab;
import static io.whz.synapse.pojo.constant.TrackCons.Main.CLICK_DOWNLOAD;
import static io.whz.synapse.pojo.constant.TrackCons.Main.CLICK_FAB;
import static io.whz.synapse.pojo.constant.TrackCons.Main.CLICK_PLAY;
import static io.whz.synapse.pojo.constant.TrackCons.Main.CLICK_TRAINED;
import static io.whz.synapse.pojo.constant.TrackCons.Main.CLICK_TRAINING;
