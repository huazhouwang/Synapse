...
import static io.whz.androidneuralnetwork.utils.Preconditions.checkNotNull;

public class ExtraWidgets {
    private static final String TAG = App.TAG + "-ExtraWidgets";
...
//    }
    ...
    public static abstract class BaseViewBuilder {
        ...
        public void attaches(@NonNull ViewGroup layout) {
            checkNotNull(layout);
            ExtraWidgets.attaches(layout, mReplacedView, this);
        }
    }
