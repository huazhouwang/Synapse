...
package io.whz.androidneuralnetwork.transitions;
...
public class FabTransform extends Transition {
     ...
     */
    public static boolean setup(@NonNull AppCompatActivity activity, @Nullable View target) {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final Interpolator fastOutSlowInInterpolator = AnimationUtils.loadInterpolator(sceneRoot.getContext(), android.R.interpolator.fast_out_linear_in);
        ...
        if (fromFab) {
            ...
            circularReveal.setInterpolator(fastOutSlowInInterpolator);
        } else {
            circularReveal = ViewAnimationUtils.createCircularReveal(view,
                    view.getWidth() / 2,
                    view.getHeight() / 2,
                    ...
                    endBounds.width() / 2);
            circularReveal.setInterpolator(AnimationUtils.loadInterpolator(sceneRoot.getContext(), android.R.interpolator.linear_out_slow_in));
